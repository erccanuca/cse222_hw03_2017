...
public class SingleLinkedListDeleteNodes <E extends Comparable<E> > {
  // Data Fields
  ...
  private int size = 0;
   ...
   /**
   * deletedToString method which creates a String of deleted nodes.
   * @param deleted will added if reuse will deleted
   */
  public void deleteToString(E deleted){
      addLast(deleted);
      removeDuplicates();    
  }
  /**
   * Remove duplicates before delete call bubble sort
   */
...
public void bubbleSort(){
    ...
    for ( i = 0 ; i < size - 1 ; i++, k-- ) {
    	...
    	for ( j = 1 ; j < k ; j++ ) {
            int compareResult = current.data.compareTo(next.data); 
    	    if (compareResult>0) {
 ...
 */
  ...
  /**
   * Recursively reverseToString method.
  ...
  */
  ...
  private class MyIterator implements Iterator < E > {
     ...
     */
    public MyIterator(int i) throws IndexOutOfBoundsException{
    ...
    /**
     * Add method
     * @param obj Generic type will add.
     */
